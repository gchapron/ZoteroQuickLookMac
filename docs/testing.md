...
Build with `./build.sh`, install `zoteroquicklookmac-1.0.11b2.xpi` in Zotero, and restart Zotero. These checks require a real Zotero library and the installed plugin; successful compilation alone does not verify them.
