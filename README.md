...
1. For this experiment, build the `.xpi` from this branch using the instructions below. Stable packages are available on the [Releases](https://github.com/gchapron/ZoteroQuickLookMac/releases) page.
...
Requires macOS and Xcode Command Line Tools. From this branch's checkout, run:
